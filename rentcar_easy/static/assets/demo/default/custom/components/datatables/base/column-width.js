var DatatableColumnWidthDemo = function () {
    var t = function () {
                ...
                data: {
                    ...
                    source: {
                        read: {
                           ...
                           url: "http://localhost:8000/marcas/fill/table",
                           //type : "GET"
        ...
        // }).val(e.generalSearch), $("#m_form_status, #m_form_type").selectpicker()
    };
    return {
        init: function () {
            t()
